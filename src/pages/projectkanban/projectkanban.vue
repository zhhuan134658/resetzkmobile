      ...
      >
        ...
        >
          <div class="itemtop">
            <div class="itemleft">
              {{
                item.file_name.length > 8
                  ? item.file_name.substring(0, 8) + '...'
                  : item.file_name
              }}
            ...
            <div class="itemright">审批中</div>
          </div>

          <div class="itemcon">
            <div class="conone">
              <div class="cononetop">14%</div>
              <div class="cononebot">项目进度</div>
            </div>
            <div class="conone">
              <div class="cononetopqq">杨磊鑫</div>
              <div class="cononebot">项目负责人</div>
            </div>
            <div class="conone">
              <div class="cononetopqq">180</div>
